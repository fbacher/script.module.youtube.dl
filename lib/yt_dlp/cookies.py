...
try:
    xbmc.log('About to import keyring', xbmc.LOGDEBUG)
    xbmc.log(f'environment: {os.environ}', xbmc.LOGDEBUG)
    import keyring
    xbmc.log('Imported keyring', xbmc.LOGDEBUG)
...
xbmc.log('Finished importing cookies', xbmc.LOGDEBUG)
